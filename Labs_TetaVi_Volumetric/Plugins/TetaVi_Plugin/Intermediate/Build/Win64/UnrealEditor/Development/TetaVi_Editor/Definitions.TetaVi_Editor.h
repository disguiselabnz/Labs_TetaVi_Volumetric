...
#define UE_MODULE_NAME "TetaVi_Editor"
#define UE_PLUGIN_NAME "TetaVi_Plugin"
...
#define TETAVI_PLUGIN_API DLLIMPORT
#define MOVIESCENECAPTURE_API DLLIMPORT
#define TETAVIPROCEDURALMESHCOMPONENT_API DLLIMPORT
#define TETAVI_EDITOR_API DLLEXPORT
